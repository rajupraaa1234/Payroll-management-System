...
public class New_Employee extends JFrame implements ActionListener{
    ...
    New_Employee(){
        ...
        p1.setLayout(new GridLayout(10,2,10,40));
        l1 = new JLabel("Name");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String pas=t9.getText();
        String qry ="insert into employee values('"+id+"','"+n+"','"+g+"','"+a+"','"+s+"','"+c+"','"+e+"','"+p+"','"+pas+"')";
        String qer  ="insert into emplogin values('"+id+"','"+pas+"')";
        try
        {
            conn c1 = new conn();
            //conn c2 = new conn();
